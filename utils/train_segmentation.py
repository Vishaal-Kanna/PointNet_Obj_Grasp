...
if test == True:
    classifier.load_state_dict(torch.load("/home/vishaal/omniverse/new_1/pointnet.pytorch/utils/gpg/gpg_model_15.pth"))
...
if test == True:
    ...
    points, point_set_before_transform = data
    # print(points.shape)
...
for epoch in range(opt.nepoch):
    ...
    for r, _ in enumerate(range_):
        for i, data in enumerate(dataloader, 0):
            ...
            loss = 1.0*F.binary_cross_entropy(torch.sigmoid(pred), gt.reshape(-1, 1), weight = mask.reshape(-1,1))
